...
<?php global $pdo;
$jenis_list = $pdo->query("SELECT id_jenis, nama_jenis FROM jenis_hewan ORDER BY nama_jenis")->fetchAll(); ?>
        ...
        <form action="index.php?page=vaksin_create" method="POST">
            <div class="form-group">
                ...
                <input type="text" name="nama_vaksin" class="form-control"
                    value="<?= htmlspecialchars($_POST['nama_vaksin'] ?? '') ?>" required autofocus>
            </div>
            <div class="form-group">
                ...
                <select name="id_jenis" class="form-control" required>
                    ...
                    <?php foreach ($jenis_list as $j): ?>
                        <option value="<?= $j['id_jenis'] ?>" <?= ($posted_jenis == $j['id_jenis']) ? 'selected' : '' ?>>
